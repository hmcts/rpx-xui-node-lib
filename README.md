...
1. Include the node library within package.json
```
"@hmcts/rpx-xui-node-lib": "^2.22.1",
```
...
@see rpx-xui-common-lib README.md for an example of how to integrate the Timeout Notification Service
and Timeout Notification Service Modal.
